...
class Counters(object):
    ...
    @cached_property
    def _redis(self):
        if getattr(settings, 'EXPERIMENTS_REDIS_URL', None):
            return redis.from_url(settings.EXPERIMENTS_REDIS_URL)
        elif getattr(settings, 'EXPERIMENTS_REDIS_SENTINELS', None):
